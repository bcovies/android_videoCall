...
public class CadastroActivity extends AppCompatActivity {
    ...
    private boolean validarNascimento(String nascimento){
        if(nascimento.isEmpty()){
            Toast.makeText(CadastroActivity.this, "Nascimento: " + nascimento, Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validarTelefone(String telefone){
        if(telefone.isEmpty()){
            Toast.makeText(CadastroActivity.this, "Telefone: " + telefone, Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validarNome(String nome){
        if(nome.isEmpty()){
            Toast.makeText(CadastroActivity.this, "Nome: " + nome, Toast.LENGTH_SHORT).show();
